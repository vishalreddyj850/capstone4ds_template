...
- This study applies K-Means clustering to segment shopping mall customers based on their spending behavior and demographic characteristics. Two clustering models were created: age vs. spending score and annual income vs. spending score. Using the elbow method, four clusters were identified for age-based segmentation, while five clusters were found for income-based segmentation.
Key insights reveal that older customers tend to have lower spending scores, while high-income individuals do not necessarily spend more. These findings help shopping malls target promotions effectively to boost revenue. The study also emphasizes how machine learning automates segmentation, making it more efficient than traditional manual analysis. Additionally, it highlights the benefits of segmentation in price optimization, customer retention, brand awareness, and revenue growth.
